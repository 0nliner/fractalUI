...
export const media = {
  ...
  hover: '(hover: hover)',
  /**
   * Палец вместо курсора. Именно по этому условию раздаётся `size.tapTarget`:
   * плотность интерфейса и минимальная цель нажатия — разные вещи, и
   * раздавать 44px безусловно значит развалить плотные админки.
   */
